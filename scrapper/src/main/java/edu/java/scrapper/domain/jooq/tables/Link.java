...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, OffsetDateTime> LAST_CHECKED_AT = createField(DSL.name("LAST_CHECKED_AT"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");

    /**
     * The column <code>LINK.LAST_COMMIT_SHA</code>.
     */
    public final TableField<LinkRecord, String> LAST_COMMIT_SHA = createField(DSL.name("LAST_COMMIT_SHA"), SQLDataType.VARCHAR(1000000000), this, "");

    /**
     * The column <code>LINK.ANSWERS_COUNT</code>.
     */
    public final TableField<LinkRecord, Long> ANSWERS_COUNT = createField(DSL.name("ANSWERS_COUNT"), SQLDataType.BIGINT, this, "");
