...
import edu.java.scrapper.services.ScrapperQueueProducer;
...
public class KafkaConfiguration {
    ...
    public ScrapperQueueProducer scrapperQueueProducer(KafkaTemplate<String, LinkUpdateDto> kafkaTemplate) {
